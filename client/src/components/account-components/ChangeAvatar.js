...
function ChangeAvatar(props) {
  ...
  // async function sa() {
  //   console.log(editor.getImageScaledToCanvas());

  //   let url = editor.getImageScaledToCanvas().toDataURL();
  //   const formData = new FormData();
  //   formData.append("avatar", url);
  //   // await fetch("http://localhost:3001/avatar", {
  //   //   method: "post",
  //   //   body: formData,
  //   // })
  //   //   .then((data) => data.json())
  ...
  //   setCanvas(<img src={imageURL} style={{ borderRadius: "50px" }}></img>);
  // }
  // const handleDrop = (dropped) => {
  //   let file = dropped.map((file) =>
  //     Object.assign(file, {
